exports.policyData = {
  ...
  serviceMap: {
    ...
    "AWS SSO": {
      ...
      ARNFormat: "arn:${Partition}:sso:::<relative-id>",
    ...
    "AWS Resource Access Manager": {
      ...
      ARNFormat:
        "arn:aws:ram:${Region}:${AccountId}:resource-share/${Resource-UUID}",
    ...
    "Amazon Connect Wisdom": {
      ...
      ARNFormat:
        "arn:aws:wisdom:${Region}:${Account}:${Resource}/${ResourceId}",
    ...
    "Amazon Textract": {
      ...
      ARNFormat:
        "arn:${Partition}:textract:${Region}:${AccountID}:${RelativeId}",
    ...
    "AWS Performance Insights": {
      ...
      ARNFormat:
        "arn:aws:pi:${Region}:${Account}:${ResourceType}/${RelativeId}",
      ARNRegex: "^arn:aws:pi:.+",
      HasResource: true,
    },
    "Amazon Kinesis Analytics V2": {
      ...
      ARNRegex:
        "^arn:aws:kinesisanalytics:.+:[0-9]+:application/[a-zA-Z0-9_.-]+",
      conditionKeys: [
        "aws:RequestTag/${TagKey}",
        "aws:ResourceTag/${TagKey}",
        "aws:TagKeys",
